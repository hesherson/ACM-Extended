...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B171";')) { throw 'This checkout is not B171.' }
    ...
    Write-Host "B171 deployed to $target. Restart Arma/server and check the B171 debug marker."
} finally {
    Pop-Location
}
