...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B161";')) { throw 'This checkout is not B161.' }
    ...
    Write-Host "B161 deployed to $target. Restart Arma/server and check the B161 debug marker."
} finally {
    Pop-Location
}
