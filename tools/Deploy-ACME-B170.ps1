...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B170";')) { throw 'This checkout is not B170.' }
    ...
    Write-Host "B170 deployed to $target. Restart Arma/server and check the B170 debug marker."
} finally {
    Pop-Location
}
