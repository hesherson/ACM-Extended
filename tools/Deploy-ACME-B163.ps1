...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B163";')) { throw 'This checkout is not B163.' }
    ...
    Write-Host "B163 deployed to $target. Restart Arma/server and check the B163 debug marker."
} finally {
    Pop-Location
}
