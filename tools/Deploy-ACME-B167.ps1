...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B167";')) { throw 'This checkout is not B167.' }
    ...
    Write-Host "B167 deployed to $target. Restart Arma/server and check the B167 debug marker."
} finally {
    Pop-Location
}
