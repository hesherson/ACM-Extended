...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B169";')) { throw 'This checkout is not B169.' }
    ...
    Write-Host "B169 deployed to $target. Restart Arma/server and check the B169 debug marker."
} finally {
    Pop-Location
}
