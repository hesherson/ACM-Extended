...
try {
    ...
    if (-not $startup.Contains('ACME_buildBatch = "B165";')) { throw 'This checkout is not B165.' }
    ...
    Write-Host "B165 deployed to $target. Restart Arma/server and check the B165 debug marker."
} finally {
    Pop-Location
}
