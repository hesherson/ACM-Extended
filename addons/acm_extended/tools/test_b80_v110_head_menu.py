...
check('provider DraggerBase wrapper', 'private _first = "AmovPknlMstpSnonWnonDnon_AinvPknlMstpSnonWnonDnon_Putdown";' in seq and 'private _second = "AinvPknlMstpSnonWnonDnon_Putdown_AmovPknlMstpSnonWnonDnon";' in seq)
...
check('provider waits for one preflight', '_prepDelay = [_medic] call ACME_fnc_medicAnimationPrep' in seq and '_prepUntil' in seq and 'currentWeapon _u != "" && {_now < _prepUntil}' in seq)
