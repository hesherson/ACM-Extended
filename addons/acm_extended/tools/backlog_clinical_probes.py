"""Supplementary historical contracts executing shipped SQF, not source bundles.

Arma objects, CBA transport, rendering and inventory interfaces are explicitly
mocked. These offline probes do not certify live multiplayer or clinical dosing.
No production source is altered.
"""
import re
