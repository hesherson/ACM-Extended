...
// free.
if (_selClass != "") then {
    private _avail = [ACE_player, _selClass] call ACME_fnc_itemCount;
    if (!isNull _targetPatient) then { _avail = _avail + ([_targetPatient, _selClass] call ACME_fnc_itemCount); };
